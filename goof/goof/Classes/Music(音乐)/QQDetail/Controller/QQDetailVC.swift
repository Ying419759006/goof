...
extension QQDetailVC {
    ...
    override func viewDidLoad() {
       ...
       setUpViewOnce()
        ...
        // 监听播放完成的通知
        NSNotificationCenter.defaultCenter().addObserver(self, selector: "nextMusic", name: kPlayFinishNotificationName, object: nil)
...
extension QQDetailVC {
    ...
    func addTimer() -> () {
        timer = NSTimer(timeInterval: 1, target: self, selector: "setUpDataTimes", userInfo: nil, repeats: true)
    ...
    func addDisplayLink() -> () {
        ...
        displayLink = CADisplayLink(target: self, selector:"updateLrc")
